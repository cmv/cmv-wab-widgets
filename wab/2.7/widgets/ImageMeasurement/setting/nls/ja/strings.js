define({
  ...
  "errorSectionMessage": "測定機能をサポートしているレイヤーがありません",
  "unitLabel": {
    "esriInches": "インチ",
    "esriFeet": "フィート",
    "esriYards": "ヤード",
  ...
  "operationLabel": {
    "esriMensurationPoint": "位置",
    "esriMensurationDistanceAndAngle": "距離と角度",
    "esriMensurationAreaAndPerimeter": "面積と周囲長",
    "esriMensurationHeightFromBaseAndTop": "高さ: 底面から最上部",
    "esriMensurationHeightFromBaseAndTopShadow": "高さ: 底面から最上部 - 影",
    "esriMensurationHeightFromTopAndTopShadow": "高さ: 最上部から最上部 - 影",
    "esriMensurationCentroid": "重心",
    "esriMensurationPoint3D": "位置 (3D)",
