define({
  ...
  "errorSectionMessage": "אף אחת מהשכבות אינה תומכת ביכולות מדידה",
  "unitLabel": {
    "esriInches": "אינצ׳ים",
    "esriFeet": "רגל",
    "esriYards": "יארד",
  ...
  "operationLabel": {
    "esriMensurationPoint": "מיקום",
    "esriMensurationDistanceAndAngle": "מרחק וזווית",
    "esriMensurationAreaAndPerimeter": "אזור והיקף",
    "esriMensurationHeightFromBaseAndTop": "גובה: מהבסיס עד שיא הגובה",
    "esriMensurationHeightFromBaseAndTopShadow": "גובה: מהבסיס עד הקצה העליון של ההצללה",
    "esriMensurationHeightFromTopAndTopShadow": "גובה: מהפסגה עד הקצה העליון של ההצללה",
    "esriMensurationCentroid": "צנטרואיד",
    "esriMensurationPoint3D": "מיקום (3D)",
