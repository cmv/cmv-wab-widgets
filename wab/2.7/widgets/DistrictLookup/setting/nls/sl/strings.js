...
define({
  ...
  "layerSetting": {
    ...
    "selectPrecinctSymbolLabel": "Izberite simbol za osvetljevanje poligona",
  ...
  "layerSelector": {
    ...
    "selectRelatedPointLayerLabel": "Izberite točkovni sloj, ki je v relaciji s poligonskim slojem",
    "selectRelatedPointLayerHintText": "Namig: Uporablja se za izbiro točkovnega sloja, ki je v relaciji s poligonskim slojem",
    "polygonLayerNotHavingRelatedLayer": "Izberite poligonski sloj, ki je v relaciji z točkovnim slojem.",
    "errorInSelectingPolygonLayer": "Izberite poligonski sloj, ki je v relaciji z točkovnim slojem.",
    "errorInSelectingRelatedLayer": "Izberite točkovni sloj, ki je v relaciji s poligonskim slojem."
  },
  "routeSetting": {
    "routeSettingTabTitle": "Nastavitve navodil za pot",
    "routeServiceUrl": "Storitev usmerjanja",
    "buttonSet": "Nastavi",
    "routeServiceUrlHintText": "Namig: Kliknite »Nastavi« za brskanje in izbiro storitve usmerjanja mrežne analize",
