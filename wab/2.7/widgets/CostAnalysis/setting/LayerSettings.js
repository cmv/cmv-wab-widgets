...
define([
  ...
  return declare([BaseWidget, Evented, _WidgetsInTemplateMixin], {
      ...
      if (opLayers.length === 0) {
        ...
        array.forEach(opLayers,
          lang.hitch(this, function (currentLayer) {
            ...
            if (currentLayer.layerType === "ArcGISFeatureLayer" &&
    ...
    _checkEditCapabilities: function (currentLayer) {
      ...
      if (currentLayer.capabilities && currentLayer.capabilities.indexOf("Delete") !== -1 &&
     ...
     * @memberOf setting/LayerSettings
     */
    _enableDisableEditableCheckbox: function (tableRow, isLayerEditable) {
      ...
      if (!isLayerEditable) {
        ...
        domClass.remove(checkboxNode.domNode, "jimu-state-disabled");
        checkboxNode.set('status', true);
        if (tableRow.selectFields) {
    ...
    _createFieldsRows: function (layerRow, editable) {
      ...
      this._enableDisableEditableCheckbox(row.tr, editable);
    },
