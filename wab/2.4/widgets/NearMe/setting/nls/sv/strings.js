...
define({
  ...
  "errorStrings": {
    ...
    "defaultBufferValueGreaterThanOne": "Standardvärdet för buffertavstånd får inte vara mindre än 1",
    "maximumBufferValueGreaterThanOne": "Ange ett maxvärde för buffertavståndet som är större än 1",
