...
define([
  ...
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    **/
    _initTabs: function () {
      var layerSettingTab, routeSettingTab, searchSourceSettingTab, tabs;
    ...
    **/
    getConfig: function () {
      var searchSources, maxResultCount;
      ...
      // maximum slider value should not be less than equal to 1 as minimum value is 1
      if (Number(this.maxBufferDistanceNode.value) <= 1) {
      ...
      if (Number(this.defaultBufferDistanceNode.value) < 1) {
