...
define([
  ...
  function(declare, lang, BaseWidget, portalUrlUtils, shareUtils, ShareLink, /*topic,*/LoadingShelter, Message) {
    ...
    return declare([BaseWidget], {
      ...
      onOpen: function() {
        ...
        shareUtils.getItemShareInfo(this.appConfig.portalUrl).then(lang.hitch(this, function(shareInfo) {
          ...
          if (this.shareLink && this.shareLink.onShareToPublicChanged) {
      ...
      startup: function() {
        ...
        shareUtils.getItemShareInfo(this.appConfig.portalUrl).then(lang.hitch(this, function(result) {
          ...
          this.shareLink = new ShareLink({
            ...
            isOnline: portalUrlUtils.isOnline(window.top.location.href/*this.appConfig.portalUrl*/),
