...
define({
  root: ({
    ...
    selectLocationToolTip: "Click to add point", //Shown as tooltip when select location button is clicked
    ...
    directionTabTitle: "Direction", //Shown as title for direction tab
