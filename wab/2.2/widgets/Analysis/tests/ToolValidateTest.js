define(["require", "exports", 'intern!bdd', 'intern/chai!expect', 'widgets/Analysis/toolValidate'], function (require, exports, bdd, expect, ToolValidate) {
    ...
    bdd.describe('Analysis toolValidate test', function () {
        ...
        bdd.describe('sub suite -- check extract data tool', function () {
            ...
            bdd.it('FeatureLayer with url containing orgId but user is not admin should not support extract', function () {
                var layerObject = {
                    id: 'layer0',
                    geometryType: 'esriGeometryPoint',
                    declaredClass: 'esri.layers.FeatureLayer',
            ...
            bdd.it('FeatureLayer with url not containing orgId and user is admin should not support extract', function () {
                var layerObject = {
                    id: 'layer0',
                    geometryType: 'esriGeometryPoint',
                    declaredClass: 'esri.layers.FeatureLayer',
                    url: 'http://www.arcgis.com/rest/services/xxx'
                };
                _this.privilegeUtil.isAdmin = function () {
                    return true;
                };
            ...
            bdd.it('FeatureLayer with url containing orgId and user is admin should support extract', function () {
                var layerObject = {
                    id: 'layer0',
                    geometryType: 'esriGeometryPoint',
                    declaredClass: 'esri.layers.FeatureLayer',
                    url: 'http://www.arcgis.com/oC086ufSSQ6Avnw2/rest/services/xxx'
                };
                _this.privilegeUtil.isAdmin = function () {
                    return true;
                };
