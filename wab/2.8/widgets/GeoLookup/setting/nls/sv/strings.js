define({
  ...
  "fieldTable": {
    ...
    "colAlias": "Alias",
    "colOrder": "Åtgärder",
    "label": "Markera de fält du vill lägga till. Välj ett fält om du vill uppdatera dess alias och ordning."
  },
  "symbolArea": {
  ...
  "advSettings": {
    ...
    "geometryServiceDesc": "URL till geometritjänst för omprojektion av punkter."
  },
