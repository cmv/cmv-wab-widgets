define({
  ...
  "fieldTable": {
    ...
    "colOrder": "Ações",
    "label": "Marque os campos que deseja anexar. Selecione um campo para atualizar seu nome alternativo e ordem."
  },
  "symbolArea": {
  ...
  "advSettings": {
    ...
    "intersectOutDesc": "Valor para armazenar quando a localização não interseccionar um polígono.",
    ...
    "geometryServiceDesc": "URL do Serviço de Geometria para reprojeção de pontos."
  },
