define({
  "allowSaveAs": "Zezwalaj na eksport",
  "startingState": "Stan początkowy:",
  "byUrl": "Model pusty",
  "byItem": "Model wstępnie skonfigurowany",
  "imageServiceUrl": "Adres URL usługi rastrowej",
  "validate": "Sprawdź poprawność",
  "validating": "Trwa weryfikacja...",
  "validated": "Adres URL jest prawidłowy.",
  "modelName": "Model",
  "selectModel": "Zaznacz",
  "itemSelectorTitle": "Wybierz model",
  "ok": "OK",
  "cancel": "Anuluj",
  "description1": "Program modelujący przydatność służy do znajdowania najlepszej lokalizacji aktywności, prognozowania podatności na ryzyko oraz określania prawdopodobnego miejsca wystąpienia zdarzenia. Ten widżet umożliwia połączenie różnych warstw i wyznaczenie ich wagi w celu jednoczesnej oceny wielu czynników.",
  ...
  "description3": "Dowiedz się więcej na temat programu modelującego przydatność GeoPlanner."
});