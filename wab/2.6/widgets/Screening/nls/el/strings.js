...
define({
  ...
  "unableToDrawBuffer": "Δεν είναι δυνατή η σχεδίαση ζώνης.",
  ...
  "reportsTab": {
    ...
    "showAreaInText": "Εμφάνιση περιοχών σε",
    "metricUnitsText": "Μετρικές μονάδες",
    "standardUnitsText": "Τυπικές μονάδες",
