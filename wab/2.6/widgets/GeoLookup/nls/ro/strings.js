define({
  ...
  "error": {
    ...
    "invalidCoord": "Câmpurile de locaţie sunt nevalide. Vă rugăm să verificaţi fişierul CSV.",
    "tooManyRecords": "Ne pare rău, maximum ${0} înregistrări momentan.",
    "CSVNoRecords": "Acest fişier nu conţine nicio înregistrare.",
    "CSVEmptyFile": "Fişierul nu conţine nimic."
  },
  "results": {
