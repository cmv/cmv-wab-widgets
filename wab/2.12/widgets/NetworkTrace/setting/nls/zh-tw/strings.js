define({
  ...
  "projectSetting": {
    ...
    "selectLabel": "選擇",
    "polygonLayerHelp": "<p>將顯示包含下列條件的多邊形圖層:<br/><li> 圖層必須具有名為「建立」、「刪除」和「更新」的編輯功能</li><li>圖層必須具有包含實際名稱和資料類型的 2 個欄位:</li><ul><li>name (字串類型欄位)</li><li>globalid (GlobalID 類型欄位)</li></ul><p/>",
    "outputParameterHelp": "<p>將顯示來自任務 URL 的輸出多邊形圖層<p/>",
    "pointLayerHelp": "<p>將顯示包含下列條件的點圖層: <br/><li> 圖層必須具有名為「建立」、「刪除」和「更新」的編輯功能</li><li>圖層必須具有包含實際名稱和資料類型的 2 個欄位:</li><ul><li>inputtype (字串類型欄位)</li><li>projectid (GUID 類型欄位)</li></ul><p/>"
  },
  "inputOutputTab": {
    "title": "輸入/輸出",
    ...
    "setScale": "設定比例",
    "outputDisplay": "顯示文字",
    "saveToLayerHelp": "<p>將顯示包含下列條件的圖層:<br/><li> 圖層必須具有名為「建立」、「刪除」和「更新」的編輯功能</li><li>圖層必須具有包含名稱和資料類型的 2 個欄位:</li><ul><li>parametername (字串類型欄位)</li><li>projectid (Guid 類型欄位)</li></ul><p/>"
  },
  "summaryTab": {
    "title": "摘要",
  ...
  "generalSettings": {
    "title": "一般設定",
    "displayTextForButtonLegend": "「執行」按鈕的顯示文字",
    "displayTextforButtonDefaultValue": "執行",
    "displayTextForButton": "顯示文字",
    "autoZoomAfterTrace": "縮放選項",
    "zoomText": "追蹤後自動縮放"
  },
