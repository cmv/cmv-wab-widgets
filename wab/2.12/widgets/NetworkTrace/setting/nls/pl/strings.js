define({
  ...
  "projectSetting": {
    ...
    "selectLabel": "Zaznacz",
    "polygonLayerHelp": "<p>Zostaną wyświetlone warstwy poligonowe spełniające poniższe warunki:<br/><li>Warstwa musi mieć możliwość edycji, a więc atrybut “Tworzenie”, “Usuwanie” i “Aktualizacja”</li><li>Warstwa musi mieć 2 pola z dokładną nazwą i dokładnym typem danych:</li><ul><li>nazwa (pole typu znakowego)</li><li>globalid (pole typu GlobalID)</li></ul><p/>",
    "outputParameterHelp": "<p>Zostaną wyświetlone wynikowe warstwy poligonowe z adresu URL zadania<p/>",
    "pointLayerHelp": "<p>Zostaną wyświetlone warstwy punktowe spełniające poniższe warunki:<br/><li>Warstwa musi mieć możliwość edycji, a więc atrybut “Tworzenie”, “Usuwanie” i “Aktualizacja”</li><li>Warstwa musi mieć 2 pola z dokładną nazwą i dokładnym typem danych:</li><ul><li>inputtype (pole typu znakowego)</li><li>projectid (pole typu GUID)</li></ul><p/>"
  },
  "inputOutputTab": {
    ...
    "saveToLayerHelp": "<p>Zostaną wyświetlone warstwy spełniające poniższe warunki:<br/><li>Warstwa musi mieć możliwość edycji, a więc atrybut “Tworzenie”, “Usuwanie” i “Aktualizacja”</li><li>Warstwa musi mieć dwa pola z nazwą i typem danych:</li><ul><li>parametername (pole typu znakowego)</li><li>projectid (pole typu Guid)</li></ul><p/>"
  },
  "summaryTab": {
    "title": "Podsumowanie",
  ...
  "generalSettings": {
    ...
    "displayTextForButtonLegend": "Tekst wyświetlany dla przycisku 'Uruchom'",
    "displayTextforButtonDefaultValue": "Uruchom",
    "displayTextForButton": "Tekst wyświetlany",
    "autoZoomAfterTrace": "Opcje powiększenia",
