define({
  ...
  "projectSetting": {
    ...
    "polygonLayerHelp": "<p>A következő feltételeknek megfelelő polygonrétegek jelennek meg:<br/><li>A rétegnek támogatnia kell a szerkesztési műveleteket, nevezetesen a „Létrehozás”,a „Törlés” és a „Frissítés” műveletet</li><li>A rétegnek két, pontos névvel és adattípussal rendelkező mezőt kell tartalmaznia:</li><ul><li>név (karakterlánc típusú mező)</li><li>globális azonosító (globális azonosító típusú mező)</li></ul><p/>",
    "outputParameterHelp": "<p>A feladat-URL-ből származó kimeenti polygonrétegek jelennek meg<p/>",
    "pointLayerHelp": "<p>A következő feltételeknek megfelelő pontrétegek jelennek meg: <br/><li>A rétegnek támogatnia kell a szerkesztési műveleteket, nevezetesen a „Létrehozás”,a „Törlés” és a „Frissítés” műveletet</li><li>A rétegnek két, pontos névvel és adattípussal rendelkező mezőt kell tartalmaznia:</li><ul><li>bemenet típusa (karakterlánc típusú mező)</li><li>projektazonosító (globális azonosító típusú mező)</li></ul><p/>"
  },
  "inputOutputTab": {
    ...
    "saveToLayerHelp": "<p>A következő feltételeknek megfelelő pontrétegek jelennek meg:<br/><li>A rétegnek támogatnia kell a szerkesztési műveleteket, nevezetesen a „Létrehozás”,a „Törlés” és a „Frissítés” műveletet</li><li>A rétegnek két, pontos névvel és adattípussal rendelkező mezőt kell tartalmaznia::</li><ul><li>paraméternév (karakterlánc típusú mező)</li><li>projektazonosító (globális azonosító típus mező)</li></ul><p/>"
  },
  "summaryTab": {
    "title": "Összefoglalás",
  ...
  "generalSettings": {
    ...
    "displayTextForButtonLegend": "„Futtatás” gomb használatakor megjelenített szöveg",
    "displayTextforButtonDefaultValue": "Futtatás",
    "displayTextForButton": "Megjelenített szöveg",
    "autoZoomAfterTrace": "Nagyítási/kicsinyítési lehetőségek",
