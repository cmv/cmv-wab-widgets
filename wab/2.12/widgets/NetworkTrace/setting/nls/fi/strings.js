define({
  ...
  "projectSetting": {
    ...
    "selectLabel": "Valitse",
    "polygonLayerHelp": "<p>Seuraavia ehtoja vastaavat aluekarttatasot näytetään:<br/><li>Karttatasossa on oltava muokkaustoiminnot eli Luo, Poista ja Päivitä</li><li>Karttatasossa on oltava kaksi kenttää, joissa on tarkat nimi- ja tietotyypit:</li><ul><li>nimi (String-tyypin kenttä)</li><li>globalid (GlobalID-tyypin kenttä)</li></ul><p/>",
    "outputParameterHelp": "<p>Tehtävän URL-osoitteen tulosaineiston aluekarttatasot näytetään<p/>",
    "pointLayerHelp": "<p>Seuraavia ehtoja vastaavat pistekarttatasot näytetään:<br/><li>Karttatasossa on oltava muokkaustoiminnot eli Luo, Poista ja Päivitä</li><li>Karttatasossa on oltava kaksi kenttää, joissa on tarkat nimi- ja tietotyypit:</li><ul><li>inputtype  (String-tyypin kenttä)</li><li>projectid (GUID-tyypin kenttä)</li></ul><p/>"
  },
  "inputOutputTab": {
    "title": "Syöte/Tulos",
    ...
    "saveToLayerHelp": "<p>Seuraavia ehtoja vastaava karttataso näytetään:<br/><li>Karttatasossa on oltava muokkaustoiminnot eli Luo, Poista ja Päivitä</li><li>Karttatasossa on oltava kaksi kenttää, joissa on nimi- ja tietotyypit:</li><ul><li>parametername (String-tyypin kenttä)</li><li>projectid (GUID-tyypin kenttä)</li></ul><p/>"
  },
  "summaryTab": {
    "title": "Yhteenveto",
  ...
  "generalSettings": {
    ...
    "displayTextForButtonLegend": "Suorita-painikkeen näyttöteksti",
    "displayTextforButtonDefaultValue": "Suorita",
    "displayTextForButton": "Näyttöteksti",
    "autoZoomAfterTrace": "Tarkennusasetukset",
