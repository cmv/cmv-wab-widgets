define({
  ...
  "projectSetting": {
    ...
    "selectLabel": "Вибір",
    "polygonLayerHelp": "<p>Буде показано шар(-и) полігонів з наступними умовами:<br/><li>Шар повинен мати можливості редагування, а саме «Створити», «Видалити» та «Оновити»</li><li>Шар повинен мати 2 поля з точним іменем та типом даних:</li><ul><li>ім'я (поле рядкового типу)</li><li>globalid (поле типу GlobalID)</li></ul><p/>",
    "outputParameterHelp": "<p>Буде показано вихідний шар(и) полігонів з URL задачі<p/>",
    "pointLayerHelp": "<p>Буде показано шар(-и) точок з наступними умовами:<br/><li>Шар повинен мати можливості редагування, а саме «Створити», «Видалити» та «Оновити»</li><li>Шар повинен мати 2 поля з точним іменем та типом даних:</li><ul><li>inputtype (поле рядкового типу)</li><li>projectid (поле типу GUID)</li></ul><p/>"
  },
  "inputOutputTab": {
    "title": "Ввід/вивід",
    ...
    "saveToLayerHelp": "<p>Буде показано шар з наступними умовами:<br/><li>Шар повинен мати можливості редагування, а саме «Створити», «Видалити» та «Оновити»</li><li>Шар повинен мати два поля з іменем та типом даних:</li><ul><li>parametername (поле рядкового типу)</li><li>projectid (поле типу Guid)</li></ul><p/>"
  },
  "summaryTab": {
  ...
  "generalSettings": {
    ...
    "displayTextForButtonLegend": "Текст відображення для кнопки «Виконати»",
    "displayTextforButtonDefaultValue": "Запустити",
    "displayTextForButton": "Текст відображення",
    "autoZoomAfterTrace": "Опції масштабування",
