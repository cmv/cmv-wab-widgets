define({
  ...
  "projectSetting": {
    ...
    "polygonLayerHelp": "<p>Es mostraran les capes de polígon amb les condicions següents:<br/><li>La capa ha de tenir funcions d'edició, com ara \"Crea\", \"Suprimeix\" i \"Actualitza\"</li><li>La capa ha de tenir dos camps amb el nom i el tipus de dades exactes:</li><ul><li>name (camp de tipus de cadena)</li><li>globalid (cap de tipus GlobalID)</li></ul><p/>",
    "outputParameterHelp": "<p>Es mostraran les capes de polígon des de la URL de la tasca<p/>",
    "pointLayerHelp": "<p>Es mostraran les capes de punt amb les condicions següents: <br/><li>La capa ha de tenir funcions d'edició, com ara \"Crea\", \"Suprimeix\" i \"Actualitza\"</li><li>La capa ha de tenir dos camps amb el nom i el tipus de dades exactes:</li><ul><li>inputtype (camp de tipus de cadena)</li><li>projectid (camp de tipus GUID)</li></ul><p/>"
  },
  "inputOutputTab": {
    ...
    "saveToLayerHelp": "<p>Es mostrarà la capa amb les condicions següents:<br/><li>La capa ha de tenir funcions d'edició, com ara \"Crea\", \"Suprimeix\" i \"Actualitza\"</li><li>La capa ha de tenir dos camps amb el nom i el tipus de dades:</li><ul><li>parametername (camp de tipus de cadena)</li><li>projectid (camp de tipus GUID)</li></ul><p/>"
  },
  "summaryTab": {
    "title": "Resum",
  ...
  "generalSettings": {
    ...
    "displayTextForButtonLegend": "Text de visualització del botó \"Executa\"",
    "displayTextforButtonDefaultValue": "Executa",
    "displayTextForButton": "Text de visualització",
    "autoZoomAfterTrace": "Opcions de zoom",
