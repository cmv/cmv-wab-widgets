define({
  ...
  "projectSetting": {
    ...
    "selectLabel": "Vali",
    "polygonLayerHelp": "<p>Näidatakse polügoonikihti (-kihte) järgmiste tingimustega:<br/><li>Kihil peavad olema muutmisfunktsioonid, nimelt „Loo“, „Kustuta“ ja „Värskenda“</li><li>Kihil peab olema 2 välja täpse nime- ja andmetüübiga:</li><ul><li>nimi (stringitüüpi väli)</li><li>globalid (GlobalID tüüpi väli)</li></ul><p/>",
    "outputParameterHelp": "<p>Näidatakse väljundpolügooni kihti (kihte) ülesande URL-ilt<p/>",
    "pointLayerHelp": "<p>Näidatakse punktkihti (-kihte) järgmiste tingimustega:<br/><li>Kihil peavad olema muutmisfunktsioonid, nimelt „Loo“, „Kustuta“ ja „Värskenda“</li><li>Kihil peab olema 2 välja täpse nime- ja andmetüübiga:</li><ul><li>nimi (stringitüüpi väli)</li><li>globalid (GUID-tüüpi väli)</li></ul><p/>"
  },
  "inputOutputTab": {
    ...
    "saveToLayerHelp": "<p>Näidatakse kihti järgmiste tingimustega:<br/><li>Kihil peavad olema muutmisfunktsioonid, nimelt „Loo“, „Kustuta“ ja „Värskenda“</li><li>Kihil peab olema kaks välja nime- ja andmetüübiga:</li><ul><li>nimi (stringitüüpi väli)</li><li>globalid (Guid-tüüpi väli)</li></ul><p/>"
  },
  "summaryTab": {
    "title": "Kokkuvõte",
  ...
  "generalSettings": {
    "title": "Üldseaded",
    "displayTextForButtonLegend": "Nupu „Käivita“ kuvatekst",
    "displayTextforButtonDefaultValue": "Käivita",
    "displayTextForButton": "Kuvamise tekst",
    "autoZoomAfterTrace": "Suumimise variandid",
