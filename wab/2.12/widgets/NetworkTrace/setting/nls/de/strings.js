define({
  ...
  "projectSetting": {
    ...
    "polygonLayerHelp": "<p>Polygon-Layer mit den folgenden Bedingungen werden angezeigt:<br/><li>Layer muss die Bearbeitungsfunktionen \"Erstellen\", \"Löschen\" und \"Aktualisieren\" aufweisen</li><li>Layer muss 2 Felder mit genau dem folgendem Namen und Datentyp aufweisen:</li><ul><li>name (Feld vom Typ \"Zeichenfolge\")</li><li>globalid (Feld vom Typ \"GlobalID\")</li></ul><p/>",
    "outputParameterHelp": "<p>Ausgabe-Polygon-Layer aus der Task-URL werden angezeigt<p/>",
    "pointLayerHelp": "<p>Punkt-Layer mit den folgenden Bedingungen werden angezeigt:<br/><li>Layer muss die Bearbeitungsfunktionen \"Erstellen\", \"Löschen\" und \"Aktualisieren\" aufweisen</li><li>Layer muss 2 Felder mit genau dem folgendem Namen und Datentyp aufweisen:</li><ul><li>inputtype (Feld vom Typ \"Zeichenfolge\")</li><li>projectid (Feld vom Typ \"GUID\")</li></ul><p/>"
  },
  "inputOutputTab": {
    ...
    "saveToLayerHelp": "<p>Layer mit den folgenden Bedingungen werden angezeigt:<br/><li>Layer muss die Bearbeitungsfunktionen \"Erstellen\", \"Löschen\" und \"Aktualisieren\" aufweisen</li><li>Layer muss 2 Felder mit folgendem Namen und Datentyp aufweisen:</li><ul><li>parametername (Feld vom Typ \"Zeichenfolge\")</li><li>projectid (Feld vom Typ \"GUID\")</li></ul><p/>"
  },
  "summaryTab": {
  ...
  "generalSettings": {
    ...
    "displayTextForButtonLegend": "Anzeigetext für Schaltfläche 'Ausführen'",
    "displayTextforButtonDefaultValue": "Ausführen",
    "displayTextForButton": "Anzeigetext",
    "autoZoomAfterTrace": "Zoom-Optionen",
