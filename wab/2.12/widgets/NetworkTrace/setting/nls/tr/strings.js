define({
  ...
  "projectSetting": {
    ...
    "selectLabel": "Seç",
    "polygonLayerHelp": "<p>Aşağıdaki koşulları içeren çokgen katmanları gösterilir:<br/><li>Katmanın, “Oluştur”, “Sil” ve “Güncelle” adlı düzenleme yetenekleri olmalıdır</li><li>Katmanda aynı ad ve aynı veri türüne sahip 2 alan bulunmalıdır:</li><ul><li>name (Dizi türü alan)</li><li>globalid (GlobalID türü alan)</li></ul><p/>",
    "outputParameterHelp": "<p>Görev URL’den alınan çıktı çokgen katmanları gösterilir<p/>",
    "pointLayerHelp": "<p>Aşağıdaki koşulları içeren nokta katmanları gösterilir:<br/><li>Katmanın, “Oluştur”, “Sil” ve “Güncelle” adlı düzenleme yetenekleri olmalıdır</li><li>Katmanda aynı ad ve aynı veri türüne sahip 2 alan bulunmalıdır:</li><ul><li>inputtype (Dizi türü alan)</li><li>projectid (GIUD türü alan)</li></ul><p/>"
  },
  "inputOutputTab": {
    "title": "Girdi/Çıktı",
    ...
    "saveToLayerHelp": "<p>Aşağıdaki koşulları içeren katmanlar gösterilir:<br/><li>Katmanın, “Oluştur”, “Sil” ve “Güncelle” adlı düzenleme yetenekleri olmalıdır</li><li>Katmanda ad ve veri türüne sahip iki alan bulunmalıdır:</li><ul><li>parametername (Dizi türü alan)</li><li>projectid (Guid türü alan)</li></ul><p/>"
  },
  "summaryTab": {
    "title": "Özet",
  ...
  "generalSettings": {
    "title": "Genel Ayarlar",
    "displayTextForButtonLegend": "‘Çalıştır’ düğmesi görüntü metni",
    "displayTextforButtonDefaultValue": "Çalıştır",
    "displayTextForButton": "Görüntü metni",
    "autoZoomAfterTrace": "Yakınlaştırma seçenekleri",
