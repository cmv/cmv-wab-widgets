define({
  ...
  "projectSetting": {
    ...
    "selectLabel": "Chọn",
    "polygonLayerHelp": "<p>(Các) lớp vùng có các điều kiện sau đây sẽ được hiển thị:<br/><li>Lớp phải có các khả năng chỉnh sửa tức là “Tạo”, “Xóa” và “Cập nhật”</li><li>Lớp phải chứa 2 trường có đúng tên và loại dữ liệu:</li><ul><li>name (Trường loại chuỗi)</li><li>globalid (Trường loại GlobalID)</li></ul><p/>",
    "outputParameterHelp": "<p>(Các) lớp vùng đầu ra từ URL tác vụ sẽ được hiển thị<p/>",
    "pointLayerHelp": "<p>(Các) lớp điểm có các điều kiện sau đây sẽ được hiển thị: <br/><li>Lớp phải có các khả năng chỉnh sửa tức là “Tạo”, “Xóa” và “Cập nhật”</li><li>Lớp phải chứa 2 trường có đúng tên và loại dữ liệu:</li><ul><li>inputtype (Trường loại chuỗi)</li><li>projectid (Trường loại GUID)</li></ul><p/>"
  },
  "inputOutputTab": {
    ...
    "saveToLayerHelp": "<p>Lớp có các điều kiện sau đây sẽ được hiển thị:<br/><li>Lớp phải có các khả năng chỉnh sửa tức là “Tạo”, “Xóa” và “Cập nhật”</li><li>Lớp phải chứa hai trường có đúng tên và loại dữ liệu:</li><ul><li>parametername (Trường loại chuỗi)</li><li>projectid (Trường loại Guid)</li></ul><p/>"
  },
  "summaryTab": {
  ...
  "generalSettings": {
    ...
    "displayTextForButtonLegend": "Văn bản hiển thị cho nút 'Chạy'",
    "displayTextforButtonDefaultValue": "Chạy",
    "displayTextForButton": "Văn bản hiển thị",
    "autoZoomAfterTrace": "Tùy chọn thu phóng",
