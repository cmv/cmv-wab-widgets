define({
  ...
  "projectSetting": {
    ...
    "selectLabel": "選択",
    "polygonLayerHelp": "<p>次の条件を満たすポリゴン レイヤーが表示されます:<br/><li>レイヤーは編集機能 (つまり、作成、削除、更新) を持つ必要があります</li><li>レイヤーは、次の名前およびデータ タイプの 2 つのフィールドを持つ必要があります:</li><ul><li>name (文字列タイプ フィールド)</li><li>globalid (GlobalID タイプ フィールド)</li></ul><p/>",
    "outputParameterHelp": "<p>タスク URL からの出力ポリゴン レイヤーが表示されます<p/>",
    "pointLayerHelp": "<p>次の条件を満たすポイント レイヤーが表示されます:<br/><li>レイヤーは編集機能 (つまり、作成、削除、更新) を持つ必要があります</li><li>レイヤーは、次の名前およびデータ タイプの 2 つのフィールドを持つ必要があります:</li><ul><li>li><ul><li>inputtype (文字列タイプ フィールド)</li><li>projectid (GUID タイプ フィールド)</li></ul><p/>"
  },
  "inputOutputTab": {
    "title": "入力/出力",
    ...
    "saveToLayerHelp": "<p>次の条件を満たすレイヤーが表示されます:<br/><li>レイヤーは編集機能 (つまり、作成、削除、更新) を持つ必要があります</li><li>レイヤーは、次の名前およびデータ タイプの 2 つのフィールドを持つ必要があります:</li><ul><li>li><ul><li>parametername (文字列タイプ フィールド)</li><li>projectid (Guid タイプ フィールド)</li></ul><p/>"
  },
  "summaryTab": {
    "title": "概要",
  ...
  "generalSettings": {
    "title": "一般設定",
    "displayTextForButtonLegend": "[実行] ボタンの表示テキスト",
    "displayTextforButtonDefaultValue": "実行",
    "displayTextForButton": "表示テキスト",
    "autoZoomAfterTrace": "ズーム オプション",
