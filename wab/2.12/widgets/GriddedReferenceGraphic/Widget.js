    ...
    return declare([BaseWidget, dijitWidgetBase, dijitWidgetsInTemplate], {
      ...
      _handleClickEvents: function () {
        ...
        **/
        ...
        this.own(on(this.grgPointBySizeCoordTool.dt, 'DrawComplete', lang.hitch(this, this._dt_Complete)));
        this.own(on(this.grgPointByRefSystemCoordTool.dt, 'DrawComplete', lang.hitch(this, this._dt_Complete)));
        this.own(on(this.grgPointByTimeCoordTool.dt, 'DrawComplete', lang.hitch(this, this._dt_Complete)));
        ...
        this.own(on(this.grgAreaBySizePublishGRGButton, 'click', lang.hitch(this, function () {
          if (this._isValidGRGLayerName(this.addGRGNameArea.getValue())) {
            this.publishMessage.innerHTML = '';
