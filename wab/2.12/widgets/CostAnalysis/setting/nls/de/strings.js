...
define({
  ...
  "projectSettings": {
    ...
    "pointLayerHintText": "<p>Punkt-Layer mit den folgenden Kriterien werden angezeigt: <br/> <li>\tLayer muss mit dem Projekt-Layer in Beziehung stehen</li><li>\tLayer muss das Feld 'Projectid' (Typ 'GUID') aufweisen</li><li>\tLayer muss die Bearbeitungsfunktionen 'Erstellen', 'Löschen' und 'Aktualisieren' aufweisen</li></p>"
  },
  "layerSettings": {
