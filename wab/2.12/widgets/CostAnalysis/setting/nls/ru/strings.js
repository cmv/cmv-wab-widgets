...
define({
  ...
  "projectSettings": {
    ...
    "pointLayerHintText": "<p>Будет показан точечный слой(слои), удовлетворяющие следующим условиям: <br/> <li>\tСлой должен быть связан со слоем проекта</li><li>\tУ слоя должно быть поле 'Projectid' (типа GUID)</li><li>\tУ слоя должны быть включены возможности редактирования Создание, Удаление и Обновление'</li></p>"
  },
  "layerSettings": {
