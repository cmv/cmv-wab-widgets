...
define({
  ...
  "projectSettings": {
    ...
    "pointLayerHintText": "<p>A(s) camada(s) de pontos com as seguintes condições será(ão) apresentada(s): <br/> <li>\tA camada deve estar relacionada com a Camada de Projeto</li><li>\tA camada deve conter o campo 'Projectid' (tipo de GUID)</li><li>\tA camada deve ter capacidades de edição, nomeadamente 'Criar', 'Eliminar' e 'Atualizar'</li></p>"
  },
  "layerSettings": {
