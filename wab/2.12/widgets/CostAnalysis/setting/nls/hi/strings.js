...
define({
  ...
  "projectSettings": {
    ...
    "pointLayerHintText": "<p>निम्नलिखित शर्तों के साथ पॉइंट लेयर को दिखाया जाएगा: <br/> <li>\tलेयर प्रोजेक्ट लेयर से संबंधित होना चाहिए</li><li>\tलेयर में 'प्रोजेक्टआईडी' (GUID प्रकार) फ़ील्ड होना चाहिए</li><li>\tलेयर में संपादन क्षमताएँ होनी चाहिए जैसे कि 'बनाएँ', 'हटाएँ' और 'अपडेट करें’</li></p>"
  },
  "layerSettings": {
