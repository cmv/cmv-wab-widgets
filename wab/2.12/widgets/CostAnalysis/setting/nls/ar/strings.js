...
define({
  ...
  "projectSettings": {
    ...
    "pointLayerHintText": "<p>سيتم عرض طبقات النقط ذات الحالات التالية: <br/> <li>\tيجب أن تكون الطبقة مرتبطةً بطبقة المشروع</li><li>\tيجب أن يكون للطبقة حقل \"معرف مشروع\" (من نوع الدليل)</li><li>\tيجب أن يكون للطبقة قدرات تحريرية أي \"الإنشاء\" و\"الحذف\" و\"التحديث\"</li></p>"
  },
  "layerSettings": {
