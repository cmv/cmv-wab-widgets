...
define({
  ...
  "projectSettings": {
    ...
    "pointLayerHintText": "<p>Les couches de points répondant aux conditions suivantes s’afficheront : <br/> <li>\tLa couche doit être associée à la couche de projet</li><li>\tLes couches doivent avoir un champ 'Projectid' (type GUID)</li><li>\tLa couche doit disposer des fonctionnalités de mise à jour, à savoir 'Créer', 'Supprimer' et 'Mettre à jour'</li></p>"
  },
  "layerSettings": {
