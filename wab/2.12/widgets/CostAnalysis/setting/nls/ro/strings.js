...
define({
  ...
  "projectSettings": {
    ...
    "pointLayerHintText": "<p>Vor fi afișate straturile punct cu următoarele condiții: <br/> <li>\tStratul trebuie asociat la Stratul de proiect</li><li>\tStratul trebuie să aibă câmpul 'Projectid' (tip GUID)</li><li>\tStratul trebuie să aibă capacități de editare, adică 'Creare', 'Ștergere' și 'Actualizare'</li></p>"
  },
  "layerSettings": {
  ...
  "costingInfo": {
    ...
    "updateProjectCostEquationHint": "Sugestie: Acest lucru va permite utilizatorului să actualizeze ecuațiile de cost pentru active deja adăugate la proiecte existente cu noi ecuații definite mai jos bazate pe șablon obiect spațial, geografie și scenariu. Dacă nu este găsită combinația, va fi setată la ecuație de cost implicită, adică geografie și scenariu ca 'Nimic'. În cazul unui șablon obiect spațial eliminat, costul va fi setat la 0."
  },
  "statisticsSettings": {
