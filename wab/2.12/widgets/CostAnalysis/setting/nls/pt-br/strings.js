...
define({
  ...
  "projectSettings": {
    ...
    "pointLayerHintText": "<p>Camadas de ponto com as seguintes condições serão mostradas: <br/> <li>\tA camada deve estar relacionada à Camada do Projeto</li><li>\tA camada deve ter o campo 'Projectid' (tipo GUID type) </li><li>\tA camada deve ter recursos de edição denominados 'Criar', 'Excluir' e 'Atualizar'</li></p>"
  },
  "layerSettings": {
