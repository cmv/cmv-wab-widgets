...
define({
  ...
  "projectSettings": {
    ...
    "pointLayerHintText": "<p>Se mostrarán las capas de puntos que reúnan las siguientes condiciones: <br/> <li>\tLa capa debe estar relacionada con la capa de proyecto</li><li>\tLa capa debe tener el campo 'Projectid' (tipo GUID)</li><li>\tLa capa debe presentar capacidades de edición, concretamente 'Crear', 'Eliminar' y 'Actualizar'</li></p>"
  },
  "layerSettings": {
