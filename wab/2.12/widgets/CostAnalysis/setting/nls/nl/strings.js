...
define({
  ...
  "projectSettings": {
    ...
    "pointLayerHintText": "<p>Puntla(a)g(en) die voldoen aan de volgende voorwaarden zullen worden weergegeven: <br/> <li>\tLaag moet verband houden met de projectlaag</li><li>\tLaag moet veld 'Projectid' (GUID-type) hebben</li><li>\tLaag moet bewerkingsfuncties hebben, namelijk 'Creëren', 'Verwijderen' en 'Bijwerken'</li></p>"
  },
  "layerSettings": {
