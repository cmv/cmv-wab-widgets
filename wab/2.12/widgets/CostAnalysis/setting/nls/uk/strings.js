...
define({
  ...
  "projectSettings": {
    ...
    "pointLayerHintText": "<p>Буде показано шар(-и) точок з наступними умовами: <br/> <li>\tШар має відноситися до шару проекту</li><li>\tШар повинен мати поле 'Projectid' (тип GUID)</li><li>\tШар повинен мати можливості редагування, а саме «Створити», «Видалити» та «Оновити»'</li></p>"
  },
  "layerSettings": {
