...
define({
  ...
  "projectSettings": {
    ...
    "pointLayerHintText": "<p>(Các) lớp điểm có các điều kiện sau sẽ được hiển thị: <br/> <li>\tLớp phải liên quan đến Lớp Dự án</li><li>\tLớp phải có trường 'Projectid' (loại GUID)</li><li>\tLớp phải có khả năng chỉnh sửa cụ thể là 'Tạo', 'Xóa' và 'Cập nhật'</li></p>"
  },
  "layerSettings": {
