...
define({
  ...
  "projectSettings": {
    ...
    "pointLayerHintText": "<p>יופיעו שכבות נקודות שעונות על התנאים הבאים: <br/> <li>\tהשכבה צריכה להיות קשורה לשכבת הפרויקט</li><li>\tלשכבה צריך להיות שדה  'Projectid' (סוג GUID)‏</li><li>\tלשכבה צריכות להיות יכולות עריכה של 'יצירה', 'מחיקה' ו'עדכון'</li></p>"
  },
  "layerSettings": {
