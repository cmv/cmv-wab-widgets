...
define({
  ...
  "projectSettings": {
    ...
    "pointLayerHintText": "<p>Punktlag med følgende betingelser vil blive vist: <br/> <li>\tLaget skal være knyttet til projektlaget</li><li>\tLaget skal indeholde feltet 'Projectid' (GUID-type)</li><li>\tLaget skal have redigeringsfunktioner, nemlig 'Opret', 'Slet' og 'Opdatér'</li></p>"
  },
  "layerSettings": {
