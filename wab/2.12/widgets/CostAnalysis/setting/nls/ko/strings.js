...
define({
  ...
  "projectSettings": {
    ...
    "pointLayerHintText": "<p>다음과 같은 조건의 포인트 레이어가 표시됩니다.<br/> <li>\t프로젝트 레이어와 관련되어야 하는 레이어</li><li>\t'Projectid'(GUID 유형) 필드가 있는 레이어</li><li>\t'생성', '삭제', '업데이트'라는 편집 기능이 있어야 하는 레이어</li></p>"
  },
  "layerSettings": {
    "tabTitle": "레이어 설정",
