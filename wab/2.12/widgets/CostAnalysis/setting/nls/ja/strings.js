...
define({
  ...
  "projectSettings": {
    ...
    "pointLayerHintText": "<p>次の条件を満たすポイント レイヤーが表示されます:<br/> <li>\tレイヤーはプロジェクト レイヤーと関連している必要があります</li><li>\tレイヤーは 'Projectid' (GUID タイプ) フィールドを持つ必要があります</li><li>\tレイヤーは編集機能 (つまり、作成、削除、更新) を持つ必要があります</li></p>"
  },
  "layerSettings": {
    "tabTitle": "レイヤー設定",
