...
define({
  ...
  "projectSettings": {
    ...
    "pointLayerHintText": "<p>Vengono visualizzati i layer puntuali con le seguenti condizioni: <br/> <li>\tIl layer deve essere correlato la layer di progetto</li><li>\tIl layer deve disporre di un campo 'Projectid' (tipo GUID)</li><li>\tIl layer deve avere funzionalità di modifica ovvero 'Crea', 'Elimina' e 'Aggiorna'</li></p>"
  },
  "layerSettings": {
