...
define({
  ...
  "projectSettings": {
    ...
    "pointLayerHintText": "<p>Biće prikazani tačkasti slojevi sa sledećim uslovima: <br/> <li>\tSloj mora biti povezan sa slojem projekta</li><li>\tSloj mora da ima polje 'Projectid' (GUID tip)</li><li>\tSloj mora da ima mogućnost uređivanja, tačnije 'Kreiraj', 'Izbriši' i 'Ažuriraj'</li></p>"
  },
  "layerSettings": {
