...
define({
  ...
  "projectSettings": {
    ...
    "pointLayerHintText": "<p>Punktlager med följande villkor visas: <br/> <li>\tLagret måste vara relaterat till projektlagret</li><li>\tLagret måste ha fältet Projectid (typ GUID)</li><li>\tLagret måste ha redigeringsmöjlighet, nämligen Skapa, Ta bort och Uppdatera</li></p>"
  },
  "layerSettings": {
