...
define({
  ...
  "projectSettings": {
    ...
    "pointLayerHintText": "<p>Θα εμφανίζονται σημιακά θεματικά επίπεδα που πληρούν τις εξής προϋποθέσεις: <br/> <li>\tΤο θεματικό επίπεδο πρέπει να έχει σχέση με το Θεματικό επίπεδο έργου.</li><li>\tΤο θεματικό επίπεδο πρέπει να διαθέτει πεδίο 'Projectid' (τύπου GUID).</li><li>\tΤο θεματικό επίπεδο πρέπει να διαθέτει δυνατότητες επεξεργασίας, δηλαδή τις εξής συγκεκριμένες: 'Δημιουργία', 'Διαγραφή' και 'Ενημέρωση'.</li></p>"
  },
  "layerSettings": {
