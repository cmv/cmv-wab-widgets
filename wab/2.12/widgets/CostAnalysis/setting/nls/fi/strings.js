...
define({
  ...
  "projectSettings": {
    ...
    "pointLayerHintText": "<p>Pistekarttatasot, joiden seuraavat ehdot täyttyvät, näytetään: <br/> <li>\tKarttatason on liityttävä projektikarttatasoon</li><li>\tKarttatasossa on oltava (GUID-tyypin) Projectid-kenttä</li><li>\tKarttatasossa on oltava muokkaustoiminnot eli Luo, Poista ja Päivitä</li></p>"
  },
  "layerSettings": {
