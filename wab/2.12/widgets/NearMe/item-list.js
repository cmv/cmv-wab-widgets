  ...
  return declare([_WidgetBase, Evented], {
    ...
    **/
    _attachEventOnImage: function (imageDiv, refreshIntervalTime) {
      ...
      this.own(on(imageDiv, "click", lang.hitch(this, this._displayImageAttachments, null)));
      // Show image in new tab on click of the image thumbnail
      this.own(on(imageDiv, "keydown", lang.hitch(this, this._displayImageAttachments, true)));
    ...
    * @memberOf widgets/NearMe/item-list
    **/
    _displayImageAttachments: function (isKeyPressed, evt) {
