...
define({
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "Підказка: символ для полігонального шару, який шукається",
    ...
    "addressLocationPolylineHintText": "Підказка: символ для полілінійного шару, який шукається",
