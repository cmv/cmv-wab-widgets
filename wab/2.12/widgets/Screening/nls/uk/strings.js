...
define({
  ...
  "reportsTab": {
    ...
    "analysisUnitLabelText": "Показати результати в:",
    "analysisUnitButtonTooltip": "Вибрати одиниці для аналізу",
    "analysisCloseBtnText": "Закрити",
    "feetUnit": "Фути/квадратні фути",
    "milesUnit": "Милі/акри",
    "metersUnit": "Метри/квадратні метри",
    "kilometersUnit": "Кілометри/квадратні кілометри",
    "hectaresUnit": "Кілометри/гектари",
