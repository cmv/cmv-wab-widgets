  ...
  return dojoDeclare([dijitWidgetBase, dijitTemplatedMixin, dijitWidgetsInTemplate], {
    ...
    _syncEvents: function () {
      this.own(
        ...
        dojoOn(this.inputControl.dt, 'DrawComplete', dojoLang.hitch(this, this.feedbackDidComplete)),

        dojoOn(this.inputControl, 'get-coordinate-complete', dojoLang.hitch(this, this.feedbackDidComplete))
      );
    },
