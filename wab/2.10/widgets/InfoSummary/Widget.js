...
function (BaseWidget,
  ...
  return declare([BaseWidget, _WidgetsInTemplateMixin], {
    ...
    startup: function () {
      ...
      } else if (this.showAllFeatures && !this.hidePanel) {
        this._mapExtentChange();
      }
    },
    ...
    _toggleLayerVisibility: function (obj, e) {
      ...
      if (lyr) {
        ...
        var hasSubLayerId = lyr.li && lyr.li.hasOwnProperty("subLayerId") ?
          (nulls.indexOf(typeof (lyr.li.subLayerId)) === -1 && lyr.li.subLayerId.toString() !== "-1") : false;
    ...
    _getFormattedValue: function(feature, fieldName, lyrInfo, fields){
      ...
      if (field) {
        ...
        var subtype = lyrInfo.type === "ClusterLayer" ? false :
          this._checkDomainAndSubtype(lyrInfo.layerDefinition, fieldName, feature.attributes);
