...
define([
  ...
  function (
    ...
    return declare([BaseWidget, _WidgetsInTemplateMixin, Evented], {
      ...
      * @memberOf widgets/ParcelDrafter/NewTraverse
      **/
      _addProjectedGraphic: function (layer, graphic, setExtentToLayer, setParcelClosure, startNewTraverseBtnClick) {
      ...
      **/
      _drawPoint: function (point, startNewTraverseBtnClick) {
        ...
        this._addProjectedGraphic(this.parcelPointsGraphicsLayer, graphic, false, false, startNewTraverseBtnClick);
      },
