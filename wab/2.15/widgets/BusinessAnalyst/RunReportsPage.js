  ...
  return declare([_WidgetBase, _TemplatedMixin, _WizardPage, _WidgetsInTemplateMixin], {
    ...
    runInfographic: function () {
      ...
      this.reportPlayer = new ReportPlayer({
        ...
        config: {
          esriDijitCssUrl: "https://js.arcgis.com/3.31/dijit/themes/claro/claro.css",
          esriCssUrl: "https://js.arcgis.com/3.31/esri/css/esri.css",
          playerSourceRootUrl: "https://js.arcgis.com/3.31/"
        },
        onClose: function () {
