...
define([
  ...
  template, Evented, lang, array, html, Deferred, all, query, on, jimuUtils,
  ...
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    ...
    _createMapItems: function(response) {
      ...
      array.forEach(webMaps, function(webmap) {
        _all.push(utils.getBasemapInfo(webmap.portalUrl, webmap.id));
      });

      all(_all).then(lang.hitch(this, function(basemapInfos) {
        array.forEach(basemapInfos, lang.hitch(this, function(basemap) {
          if (this.spatialReference.equals(basemap.spatialReference)) {
