...
define([
  ...
  'esri/request'
], function(lang, Deferred, array, all, SpatialReference, portalUtils,
  basePortalUrlUtils, esriRequest) {
  var mo = {};
          ...
          _getBasemapSpatialReference(basemapItem, basemapItemData)
            .then(lang.hitch(this, function(basemapSpatialRef) {
              ...
              if (curMapSpatialRefObj &&
                basemapSpatialRef &&
                curMapSpatialRefObj.equals(new SpatialReference(basemapSpatialRef.wkid))) {
  ...
  mo.getBasemapInfo = function(portalUrl, itemId) {
    ...
    return portal.getItemById(itemId).then(function(portalItem) {
      ...
      data = itemData;
      return _getBasemapSpatialReference(basemapItem, itemData);
    }).then(function(sf) {
      return {
        thumbnailUrl: basemapItem.thumbnailUrl,
