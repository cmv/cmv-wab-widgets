...
define({
  ...
  "errorStrings": {
    ...
    "defaultBufferValueGreaterThanOne": "Буферное расстояние по умолчанию не может быть меньше 1",
    "maximumBufferValueGreaterThanOne": "Укажите максимальное буферное расстояние больше 1",
