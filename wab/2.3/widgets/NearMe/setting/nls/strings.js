...
define({
  root: ({
    ...
    errorStrings: {
      ...
      defaultBufferValueGreaterThanOne: "Default buffer distance cannot be less than 1", // shown as an error label in alert box when we configure default value of slider is one
      maximumBufferValueGreaterThanOne: "Please specify the maximum buffer distance greater than 1", // shown as an error label in alert box when we configure maximum value of slider is less than or equals to 1
