...
define({
  ...
  "errorStrings": {
    ...
    "defaultBufferValueGreaterThanOne": "Η προεπιλεγμένη απόσταση ζώνης δεν μπορεί να είναι μικρότερη του 1",
    "maximumBufferValueGreaterThanOne": "Καθορίστε τη μέγιστη απόσταση ζώνης με τιμή μεγαλύτερη του 1",
